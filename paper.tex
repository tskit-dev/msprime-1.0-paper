...
% \end{column}
% \begin{column}{5cm}
\includegraphics[width=3cm]{illustrations/arg-ts.pdf}
\includegraphics[width=3cm]{illustrations/arg-ts-simplified.pdf}
\includegraphics[width=3cm]{figures/arg.pdf}
