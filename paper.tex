...
and other optional metadata. A node may optionally be
...
The final output of most population simulations is some representation
of the sequence variation among the specified samples. For coalescent
...
and there are various extensions to the basic
...
Generating simulations in \msprime\ is efficient.
...
\msprime's mutation generator is quite efficient.
