...
Since its introduction, the \msprime\ simulator has substantially
expanded the scope of coalescent simulation, enabling the
simulation and efficient analysis of datasets on a far
larger scale than previously possible.
Here, we introduce \msprime\ version 1.0,
which is built around a core model of efficiently
implementing ancestry and mutation simulations using
...
These high-performance features have been built using a collaborative,
