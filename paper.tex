...
Since its introduction, the \msprime\ simulator has significantly
extended the scope of coalescent simulation, enabling the
simulation and efficient analysis of datasets on a far
larger scale than previously possible.
Here, we introduce \msprime\ version 1.0, which
efficiently implements ancestry and mutation simulations using
...
The coalescent is a very efficient framework for population genetic
simulation, because it allows us to simulate the genetic ancestry for
a sample from a Wright-Fisher population, without explicitly representing
...
coalescent \emph{in order to} efficiently simulate data under a neutral model.
This efficiency, and the adaptability of the model to different
applications has led to dozens of different simulation tools
...
Two technological developments of recent years
pose major challenges to the majority of existing simulation methods.
...
Thus, modelling genetic variation data as a series of unlinked loci
...
and discuss opportunites for ongoing
...
% jk - this just seems clumsy to me: surely the conclusion is clear?
% and we therefore believe \msprime\ to be the most efficient
...
% More citations?
\citep{siepel2019challenges,harris2020array,gardner2021sustained}
that investing in
...
% JK: I'm going out on a limb here - do folks agree?
...
% TODO alphabetise this by author I guess
