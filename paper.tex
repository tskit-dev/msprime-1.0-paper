...
For instance,
the classic simulator \ms\ will output trees or genome sequences,
but not both.
...
Indeed, to call a mutation ``neutral'' means that its presence or absence
does not affect demography.
A number of programs exist to place mutations on trees:
in addition to \phastsim~\citep{demaio2021phastsim},
