...
Then, given a randomly generated allele frequency trajectory under
the above model, the simulation of a sweep works by assigning lineages to
...
A important goal of the msprime development model is to maximise
accessibility for prospective users and contributors. However, it is important
to acknowledge that under-representation persists in population genetics,
especially in methodology and open-source software
development~\citep{trinkenreich2021women}. The authorship
of our paper reflects this with a skew towards men and affiliations in the USA
...
to fostering a supportive collaborative environment that helps to address these
