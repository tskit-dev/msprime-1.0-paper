...
Interface
& Separation of ancestry and mutation simulations. Integration
with forward simulators such as \SLiM\ and \fwdpy.
...
& SMC, SMC', Beta- and Dirac-coalescent, discrete time Wright-Fisher,
  ...
  Discrete or continuous coordinates, arbitary ploidy,
  gene conversion.
  Recording full ARG, full migration history, census
  events.  More efficient for large numbers of populations.\\

Demography
& Improved inferface, import from Newick species tree and
*BEAST~\citep{heled2009bayesian},
Demes support~\citep{gower2022demes}, numerical methods to compute
coalescence rates.\\
...
discrete or continuous coordinates, overlaying multiple layers
of mutations, exact times associated with mutations,
restricted time interval.\\

\end{tabular}
\caption{Major features of \msprime\ 1.0 new since version
...
per base and tract length of $542$.
