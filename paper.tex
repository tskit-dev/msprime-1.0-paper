...
We have implemented selective sweeps in \msprime\ as a structured
coalescent process~\citep{braverman1995hitchhiking},
following the approach used in \discoal. The first
step in simulating a sweep is to generate
an allele frequency trajectory
from a jump process approximation to the conditional diffusion
...
We can also define trajectories to model nuetral alleles and soft
...
Since our implementation includes the basic infrastructure for the structured
