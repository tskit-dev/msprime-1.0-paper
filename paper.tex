...
\begin{figure}
% \includegraphics[width = \textwidth]{figures/gene_conversion/gc_perf_log.pdf}
% \includegraphics[width = \textwidth]{figures/gene_conversion/gc_perf.pdf}
...
\begin{figure}
\includegraphics[width=\textwidth]{figures/mutation_perf}
\caption{\label{fig-mutation-perf} Time required to run
...
Fig.~\ref{fig-mutation-perf} shows that the mutation generation
...
Fig.~\ref{fig-mutation-perf}B required less than 2 seconds to
