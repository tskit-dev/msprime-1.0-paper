...
process, to a representation of a particular genetic ancestry
using common ancestor and recombination
events~\citep[e.g.][]{minichiello2006mapping},
to being synonymous with the genetic
ancestry of a sample, without any specific details of how genetic
material disperses~\citep{mathieson2020ancestry}.
...
% If we interpret an ARG as being a graph describing genetic
% ancestry, then clearly a
