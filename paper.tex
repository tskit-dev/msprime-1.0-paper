...
This paper marks the release of \msprime\ 1.0, the current state-of-the-art
...
Demes format~\citep{gower2021demes} from the command line, as
well as simulating mutations on a given tree sequence file.
...
\msprime\ are more useful than established methods:
...
Numerous forks (i.e., independent copies) of simulators have been created to access information not provided
...
information about ancestry and mutation simulations is immediately
