...
\grgcomment{TODO: discuss Fig~\ref{fig-gc-perf} in text of GC section.}
...
As bacterial recombination can be modelled analogously to eukaryotic allelic
...
evolution. In particular, we aim to include bacterial gene transfer and utilise
...
efficiently, including recurrent, partial,
and soft selective sweeps. However in general this
...
easily run hybrid simulations, as proposed by~\cite{bhaskar2014distortion}.
