...
ABC-NN~\citep{csillery2012abc,blum2010abc} can accommodate large numbers of statistics
that are individually weakly informative, but jointly close to sufficient for the 
desired model or parameter.
...
[An example would be good here? Hmmm...]

General approaches such as
