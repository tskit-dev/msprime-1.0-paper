...
Figure~\ref{fig-recombination-perf} gives a rough idea of the runtime of
...
will involve overlapping segments of ancesty,
...
The answer depends on how $T$ commpares to $N_1$: if $T/N_1$ is large,
