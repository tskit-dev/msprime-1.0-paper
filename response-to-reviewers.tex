...
case because it is showing how well our theoretical predictions map
...
require scaled inputs). Since the values we use aren't precisely the estimates
...
\begin{reply}
Thank you for this criticism --- we have reduced the length of the manuscript
by moving some material to appendices, and tried to address specific points
raised below.
\end{reply}
...
tskit library for performing simulations.
